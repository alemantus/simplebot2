...
bool ds4_driver__msg__report__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ds4_driver.msg._report.Report", full_classname_dest, 29) == 0);
  }
  ds4_driver__msg__Report * ros_message = _ros_message;
  {  // header
...
PyObject * ds4_driver__msg__report__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ds4_driver.msg._report");
