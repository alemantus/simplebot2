...
bool ds4_driver__msg__feedback__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ds4_driver.msg._feedback.Feedback", full_classname_dest, 33) == 0);
  }
  ds4_driver__msg__Feedback * ros_message = _ros_message;
  {  // set_led
...
PyObject * ds4_driver__msg__feedback__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ds4_driver.msg._feedback");
