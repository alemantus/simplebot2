...
#ifndef DS4_DRIVER__MSG__DETAIL__STATUS__STRUCT_HPP_
#define DS4_DRIVER__MSG__DETAIL__STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__ds4_driver__msg__Status __attribute__((deprecated))
#else
# define DEPRECATED__ds4_driver__msg__Status __declspec(deprecated)
#endif
...
struct Status_
{
  ...
  using _touch0_type =
    ds4_driver::msg::Trackpad_<ContainerAllocator>;
  _touch0_type touch0;
  using _touch1_type =
    ds4_driver::msg::Trackpad_<ContainerAllocator>;
  _touch1_type touch1;
  ...
  Type & set__touch0(
    const ds4_driver::msg::Trackpad_<ContainerAllocator> & _arg)
  {
    this->touch0 = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    ds4_driver::msg::Status_<ContainerAllocator> *;
  using ConstRawPtr =
    const ds4_driver::msg::Status_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<ds4_driver::msg::Status_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<ds4_driver::msg::Status_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      ds4_driver::msg::Status_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<ds4_driver::msg::Status_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<ds4_driver::msg::Status_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<ds4_driver::msg::Status_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<ds4_driver::msg::Status_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__ds4_driver__msg__Status
    std::shared_ptr<ds4_driver::msg::Status_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__ds4_driver__msg__Status
    std::shared_ptr<ds4_driver::msg::Status_<ContainerAllocator> const>
...
using Status =
  ds4_driver::msg::Status_<std::allocator<void>>;
...
#endif  // DS4_DRIVER__MSG__DETAIL__STATUS__STRUCT_HPP_
