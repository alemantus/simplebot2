...
#ifndef DS4_DRIVER__MSG__DETAIL__REPORT__STRUCT_HPP_
#define DS4_DRIVER__MSG__DETAIL__REPORT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__ds4_driver__msg__Report __attribute__((deprecated))
#else
# define DEPRECATED__ds4_driver__msg__Report __declspec(deprecated)
#endif
...
struct Report_
{
  ...
  // pointer types
  using RawPtr =
    ds4_driver::msg::Report_<ContainerAllocator> *;
  using ConstRawPtr =
    const ds4_driver::msg::Report_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<ds4_driver::msg::Report_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<ds4_driver::msg::Report_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      ds4_driver::msg::Report_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<ds4_driver::msg::Report_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<ds4_driver::msg::Report_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<ds4_driver::msg::Report_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<ds4_driver::msg::Report_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__ds4_driver__msg__Report
    std::shared_ptr<ds4_driver::msg::Report_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__ds4_driver__msg__Report
    std::shared_ptr<ds4_driver::msg::Report_<ContainerAllocator> const>
...
using Report =
  ds4_driver::msg::Report_<std::allocator<void>>;
...
#endif  // DS4_DRIVER__MSG__DETAIL__REPORT__STRUCT_HPP_
