...
#ifndef DS4_DRIVER__MSG__DETAIL__FEEDBACK__STRUCT_HPP_
#define DS4_DRIVER__MSG__DETAIL__FEEDBACK__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__ds4_driver__msg__Feedback __attribute__((deprecated))
#else
# define DEPRECATED__ds4_driver__msg__Feedback __declspec(deprecated)
#endif
...
struct Feedback_
{
  ...
  // pointer types
  using RawPtr =
    ds4_driver::msg::Feedback_<ContainerAllocator> *;
  using ConstRawPtr =
    const ds4_driver::msg::Feedback_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<ds4_driver::msg::Feedback_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<ds4_driver::msg::Feedback_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      ds4_driver::msg::Feedback_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<ds4_driver::msg::Feedback_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<ds4_driver::msg::Feedback_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<ds4_driver::msg::Feedback_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<ds4_driver::msg::Feedback_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__ds4_driver__msg__Feedback
    std::shared_ptr<ds4_driver::msg::Feedback_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__ds4_driver__msg__Feedback
    std::shared_ptr<ds4_driver::msg::Feedback_<ContainerAllocator> const>
...
using Feedback =
  ds4_driver::msg::Feedback_<std::allocator<void>>;
...
#endif  // DS4_DRIVER__MSG__DETAIL__FEEDBACK__STRUCT_HPP_
