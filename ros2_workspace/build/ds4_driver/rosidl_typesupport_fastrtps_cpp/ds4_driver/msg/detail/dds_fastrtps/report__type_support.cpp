...
#include "ds4_driver/msg/detail/report__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ds4_driver::msg::Report & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ds4_driver::msg::Report & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const ds4_driver::msg::Report *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ds4_driver::msg::Report *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Report(full_bounded, 0);
}
...
{
  return &ds4_driver::msg::typesupport_fastrtps_cpp::_Report__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ds4_driver, msg, Report)() {
  return &ds4_driver::msg::typesupport_fastrtps_cpp::_Report__handle;
}
