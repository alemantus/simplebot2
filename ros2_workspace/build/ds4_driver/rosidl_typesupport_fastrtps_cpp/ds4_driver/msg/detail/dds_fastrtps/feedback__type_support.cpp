...
#include "ds4_driver/msg/detail/feedback__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ds4_driver::msg::Feedback & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ds4_driver::msg::Feedback & ros_message)
{
  // Member: set_led
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const ds4_driver::msg::Feedback *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ds4_driver::msg::Feedback *>(
    untyped_ros_message);
...
{
  return &ds4_driver::msg::typesupport_fastrtps_cpp::_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ds4_driver, msg, Feedback)() {
  return &ds4_driver::msg::typesupport_fastrtps_cpp::_Feedback__handle;
}
