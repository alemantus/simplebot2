...
#include "ds4_driver/msg/detail/feedback__rosidl_typesupport_fastrtps_c.h"
...
using _Feedback__ros_msg_type = ds4_driver__msg__Feedback;
...
size_t get_serialized_size_ds4_driver__msg__Feedback(
  const void * untyped_ros_message,
...
static uint32_t _Feedback__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ds4_driver__msg__Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ds4_driver
size_t max_serialized_size_ds4_driver__msg__Feedback(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_ds4_driver__msg__Feedback(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ds4_driver, msg, Feedback)() {
