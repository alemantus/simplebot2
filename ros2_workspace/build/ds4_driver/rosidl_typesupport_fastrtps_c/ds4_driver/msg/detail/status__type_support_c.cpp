...
#include "ds4_driver/msg/detail/status__rosidl_typesupport_fastrtps_c.h"
...
#include "ds4_driver/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
#include "ds4_driver/msg/detail/trackpad__functions.h"  // touch0, touch1
#include "sensor_msgs/msg/detail/imu__functions.h"  // imu
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_ds4_driver__msg__Trackpad(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_ds4_driver__msg__Trackpad(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ds4_driver, msg, Trackpad)();
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_ds4_driver
...
using _Status__ros_msg_type = ds4_driver__msg__Status;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: touch0
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ds4_driver, msg, Trackpad
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ds4_driver
size_t get_serialized_size_ds4_driver__msg__Status(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Status__ros_msg_type * ros_message = static_cast<const _Status__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_ds4_driver__msg__Trackpad(
...
static uint32_t _Status__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ds4_driver__msg__Status(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ds4_driver
size_t max_serialized_size_ds4_driver__msg__Status(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: touch0
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_ds4_driver__msg__Trackpad(
        full_bounded, current_alignment);
    }
  }
  // member: touch1
...
{
  return max_serialized_size_ds4_driver__msg__Status(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ds4_driver, msg, Status)() {
