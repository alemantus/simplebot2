...
#include "ds4_driver/msg/detail/report__rosidl_typesupport_fastrtps_c.h"
...
using _Report__ros_msg_type = ds4_driver__msg__Report;
...
size_t get_serialized_size_ds4_driver__msg__Report(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Report__ros_msg_type * ros_message = static_cast<const _Report__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Report__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ds4_driver__msg__Report(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ds4_driver
size_t max_serialized_size_ds4_driver__msg__Report(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _Report__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ds4_driver__msg__Report(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ds4_driver, msg, Report)() {
