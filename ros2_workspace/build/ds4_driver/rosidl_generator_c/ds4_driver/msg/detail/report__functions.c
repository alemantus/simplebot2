...
bool
ds4_driver__msg__Report__init(ds4_driver__msg__Report * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    ds4_driver__msg__Report__fini(msg);
    return false;
  }
  // left_analog_x
  // left_analog_y
...
void
ds4_driver__msg__Report__fini(ds4_driver__msg__Report * msg)
{
  if (!msg) {
    return;
  }
...
bool
ds4_driver__msg__Report__are_equal(const ds4_driver__msg__Report * lhs, const ds4_driver__msg__Report * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
ds4_driver__msg__Report__copy(
  const ds4_driver__msg__Report * input,
  ds4_driver__msg__Report * output)
{
  if (!input || !output) {
    return false;
  }
...
ds4_driver__msg__Report__create()
{
  ds4_driver__msg__Report * msg = (ds4_driver__msg__Report *)malloc(sizeof(ds4_driver__msg__Report));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ds4_driver__msg__Report));
  bool success = ds4_driver__msg__Report__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
void
ds4_driver__msg__Report__destroy(ds4_driver__msg__Report * msg)
{
  if (msg) {
    ds4_driver__msg__Report__fini(msg);
  }
...
bool
ds4_driver__msg__Report__Sequence__init(ds4_driver__msg__Report__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  ds4_driver__msg__Report * data = NULL;
  if (size) {
    data = (ds4_driver__msg__Report *)calloc(size, sizeof(ds4_driver__msg__Report));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ds4_driver__msg__Report__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ds4_driver__msg__Report__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
void
ds4_driver__msg__Report__Sequence__fini(ds4_driver__msg__Report__Sequence * array)
{
  if (!array) {
    return;
  }
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ds4_driver__msg__Report__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
ds4_driver__msg__Report__Sequence__create(size_t size)
{
  ds4_driver__msg__Report__Sequence * array = (ds4_driver__msg__Report__Sequence *)malloc(sizeof(ds4_driver__msg__Report__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = ds4_driver__msg__Report__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
void
ds4_driver__msg__Report__Sequence__destroy(ds4_driver__msg__Report__Sequence * array)
{
  if (array) {
    ds4_driver__msg__Report__Sequence__fini(array);
  }
  free(array);
}

bool
ds4_driver__msg__Report__Sequence__are_equal(const ds4_driver__msg__Report__Sequence * lhs, const ds4_driver__msg__Report__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ds4_driver__msg__Report__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
ds4_driver__msg__Report__Sequence__copy(
  const ds4_driver__msg__Report__Sequence * input,
  ds4_driver__msg__Report__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ds4_driver__msg__Report);
    ds4_driver__msg__Report * data =
      (ds4_driver__msg__Report *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ds4_driver__msg__Report__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          ds4_driver__msg__Report__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ds4_driver__msg__Report__copy(
