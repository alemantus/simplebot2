...
def generate_launch_description():
    ...
    package_name_gazebo = 'simplebot_simulation'
    package_name_description = 'simplebot_description'
    package_name_bringup = 'simplebot_description'

    default_robot_name = 'simplebot'
