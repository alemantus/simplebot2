...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'simplebot2/ros2_workspace/src/simplebot_description/config'
    )
    install_config_path = os.path.join(
        home,
        'simplebot2/ros2_workspace/install/simplebot_description/share/simplebot_description/config'
    )
...
def generate_launch_description():
    ...
    # Define filenames
    urdf_package = 'simplebot_description'
    urdf_filename = 'simplebot_description.urdf.xacro'

    rviz_config_filename = 'simplebot_description.rviz'
