...
bool
ds4_driver__msg__Status__init(ds4_driver__msg__Status * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    ds4_driver__msg__Status__fini(msg);
    return false;
  }
  // axis_left_x
  // axis_left_y
  ...
  // touch0
  if (!ds4_driver__msg__Trackpad__init(&msg->touch0)) {
    ds4_driver__msg__Status__fini(msg);
    return false;
  }
  // touch1
  if (!ds4_driver__msg__Trackpad__init(&msg->touch1)) {
    ds4_driver__msg__Status__fini(msg);
    return false;
  }
  // plug_usb
...
void
ds4_driver__msg__Status__fini(ds4_driver__msg__Status * msg)
{
  if (!msg) {
    return;
  }
  ...
  // battery_full_charging
  // touch0
  ds4_driver__msg__Trackpad__fini(&msg->touch0);
  // touch1
  ds4_driver__msg__Trackpad__fini(&msg->touch1);
  // plug_usb
  // plug_audio
  // plug_mic
}
...
bool
ds4_driver__msg__Status__are_equal(const ds4_driver__msg__Status * lhs, const ds4_driver__msg__Status * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // touch0
  if (!ds4_driver__msg__Trackpad__are_equal(
...
bool
ds4_driver__msg__Status__copy(
  const ds4_driver__msg__Status * input,
  ds4_driver__msg__Status * output)
{
  if (!input || !output) {
    return false;
  }
...
ds4_driver__msg__Status__create()
{
  ds4_driver__msg__Status * msg = (ds4_driver__msg__Status *)malloc(sizeof(ds4_driver__msg__Status));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ds4_driver__msg__Status));
  bool success = ds4_driver__msg__Status__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
void
ds4_driver__msg__Status__destroy(ds4_driver__msg__Status * msg)
{
  if (msg) {
    ds4_driver__msg__Status__fini(msg);
  }
...
bool
ds4_driver__msg__Status__Sequence__init(ds4_driver__msg__Status__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  ds4_driver__msg__Status * data = NULL;
  if (size) {
    data = (ds4_driver__msg__Status *)calloc(size, sizeof(ds4_driver__msg__Status));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ds4_driver__msg__Status__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ds4_driver__msg__Status__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
void
ds4_driver__msg__Status__Sequence__fini(ds4_driver__msg__Status__Sequence * array)
{
  if (!array) {
    return;
  }
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ds4_driver__msg__Status__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
ds4_driver__msg__Status__Sequence__create(size_t size)
{
  ds4_driver__msg__Status__Sequence * array = (ds4_driver__msg__Status__Sequence *)malloc(sizeof(ds4_driver__msg__Status__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = ds4_driver__msg__Status__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
void
ds4_driver__msg__Status__Sequence__destroy(ds4_driver__msg__Status__Sequence * array)
{
  if (array) {
    ds4_driver__msg__Status__Sequence__fini(array);
  }
  free(array);
}

bool
ds4_driver__msg__Status__Sequence__are_equal(const ds4_driver__msg__Status__Sequence * lhs, const ds4_driver__msg__Status__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ds4_driver__msg__Status__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
ds4_driver__msg__Status__Sequence__copy(
  const ds4_driver__msg__Status__Sequence * input,
  ds4_driver__msg__Status__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ds4_driver__msg__Status);
    ds4_driver__msg__Status * data =
      (ds4_driver__msg__Status *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ds4_driver__msg__Status__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          ds4_driver__msg__Status__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ds4_driver__msg__Status__copy(
