...
bool ds4_driver__msg__trackpad__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * ds4_driver__msg__trackpad__convert_to_py(void * raw_ros_message);
bool ds4_driver__msg__trackpad__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * ds4_driver__msg__trackpad__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool ds4_driver__msg__status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ds4_driver.msg._status.Status", full_classname_dest, 29) == 0);
  }
  ds4_driver__msg__Status * ros_message = _ros_message;
  {  // header
  ...
  {  // touch0
    ...
    if (!ds4_driver__msg__trackpad__convert_from_py(field, &ros_message->touch0)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // touch1
    ...
    if (!ds4_driver__msg__trackpad__convert_from_py(field, &ros_message->touch1)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * ds4_driver__msg__status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ds4_driver.msg._status");
  ...
  {  // touch0
    PyObject * field = NULL;
    field = ds4_driver__msg__trackpad__convert_to_py(&ros_message->touch0);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // touch1
    PyObject * field = NULL;
    field = ds4_driver__msg__trackpad__convert_to_py(&ros_message->touch1);
    if (!field) {
      return NULL;
    }
    {
