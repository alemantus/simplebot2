...
docker run --network host \
    ...
    -it \
    ros2:v0.2 bash #-c "RCUTILS_LOGGING_SEVERITY_THRESHOLD=DEBUG ros2 launch simplebot2 main_launch.py #/home/alexander/simplebot2/ros2_workspace/launch/bot_launch_legacy.py; bash"
